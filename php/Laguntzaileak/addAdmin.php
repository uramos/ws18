...
<center>
<form action="addAdmin.php" method="post" id="signUp" name="signUp">
    ...
    <div class="form-input">
		<input type="text" name="username" id="username" size="15"  title="Izen eta Abizenak letra larriz hasi mesedez." value="">
    </div>
    <div class="clearer"><!-- --></div>
    <div class="form-label"><label for="password">Pasahitza</label></div>
    <div class="form-input">
		<input type="password" name="password" id="password" size="15"  title="pasahitzak gutxienez 8 karaktere.">
    </div>
	<div class="clearer"><!-- --></div>
